...
import "./Simple_Market_With_Fees.sol";
// import "./Simple_Market_Configuration_With_Fees.sol";

contract SuspendableSimpleMarketWithFees is SimpleMarketWithFees {
    bool public closed;
    bool public suspended;

    constructor(SimpleMarketConfigurationWithFees _simpleMarketConfigurationWithFees, bool _suspended) SimpleMarketWithFees(_simpleMarketConfigurationWithFees) {
