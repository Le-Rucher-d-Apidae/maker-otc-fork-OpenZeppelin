...
contract RestrictedSuspendableMatchingMarketWith0Fees2_OrderMatchingGasTest is DSTest, VmCheat {
    MarketTester user1;
    IERC20 dai;
    IERC20 mkr;
    IERC20 dgd;
...
contract RestrictedSuspendableMatchingMarketWith0Fees2_OrderMatchingTest is DSTest, VmCheat, EventfulMarket, MatchingEvents {
    MarketTester user1;
    IERC20 dai;
    IERC20 dustToken;
    IERC20 mkr;
