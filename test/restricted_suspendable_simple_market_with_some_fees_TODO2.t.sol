...
/*
contract Restricted2SuspendableSimpleMarketWithSomeFees_Test is DSTest, VmCheat, EventfulMarket {
    MarketTester user1;
    ...
    function setUp() public override {
        super.setUp();
        console2.log("Restricted2SuspendableSimpleMarketWithSomeFees_Test: setUp()");
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_OfferTransferTestOpened is TransferTest_OpenMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_BuyTransferTestOpened is TransferTest_OpenMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_PartialBuyTransferTestOpened is TransferTest_OpenMarket {
    function testRstrctdSuspdblSmplMrktBuyTransfersFromBuyer() public {
        uint256 id = otc.offer(30, mkr, 100, dai);
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_CancelTransferTestOpened is TransferTest_OpenMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_OfferTransferTestSuspended is TransferTest_SuspendedMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_BuyTransferTestSuspended is TransferTest_SuspendedMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_PartialBuyTransferTestSuspended is TransferTest_SuspendedMarket {
    function testFailSuspndSuspdblSmplMrktBuyTransfersFromBuyer() public {
        uint256 id = otc.offer(30, mkr, 100, dai);
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_CancelTransferTestSuspended is TransferTest_SuspendedMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_OfferTransferTestClosed is TransferTest_ClosedMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_BuyTransferTestClosed is TransferTest_ClosedMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_PartialBuyTransferTestClosed is TransferTest_ClosedMarket {
    function testFailClsdSuspdblSmplMrktBuyTransfersFromBuyer() public {
        uint256 id = otc.offer(30, mkr, 100, dai);
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_CancelTransferTestClosed is TransferTest_ClosedMarket {
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_GasTest_OpenMarket is DSTest, VmCheat {
    IERC20 dai;
    IERC20 mkr;
    RestrictedSuspendableSimpleMarketWithFees otc;
    uint id;
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_GasTest_SuspendedMarket is DSTest, VmCheat {
    IERC20 dai;
    IERC20 mkr;
    RestrictedSuspendableSimpleMarketWithFees otc;
    uint id;
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_GasTest_ClosedMarket is DSTest, VmCheat {
    IERC20 dai;
    IERC20 mkr;
    RestrictedSuspendableSimpleMarketWithFees otc;
    uint id;
...
contract Restricted2SuspendableSimpleMarketWithSomeFees_GasTest_ClosedMarket2 is DSTest, VmCheat {
    IERC20 dai;
    IERC20 mkr;
    RestrictedSuspendableSimpleMarketWithFees otc;
    uint id;
