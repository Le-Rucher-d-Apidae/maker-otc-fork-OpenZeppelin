...
/// restricted_suspendable_matching_market2.t.sol
...
contract MarketTester {
    RestrictedSuspendableMatchingMarketWithFees market;
    constructor(RestrictedSuspendableMatchingMarketWithFees  market_) {
        market = market_;
    }
    ...
    function getMarket()
        public
        view
        returns (RestrictedSuspendableMatchingMarketWithFees)
    {
        return market;
    }
}

contract RestrictedSuspendableMatchingMarketWithSomeFees2_OrderMatchingGasTest is DSTest, VmCheat {
    MarketTester user1;
    IERC20 dai;
    IERC20 mkr;
    IERC20 dgd;
    RestrictedSuspendableMatchingMarketWithFees otc;
    ...
    function setUp() public override {
        ...
        // otc = new RestrictedSuspendableMatchingMarketWithFees(address(dai), 0, address(priceOracle));
        ...
        // otc = new RestrictedSuspendableMatchingMarketWithFees(IERC20(dai), false, IERC20(dai), 0, address(priceOracle));

        address feeCollector = someUser_99;
        ...
        otc = new RestrictedSuspendableMatchingMarketWithFees( dai, simpleMarketConfigurationWithZeroFees, false, matchingMarketConfiguration);
...
contract RestrictedSuspendableMatchingMarketWithSomeFees2_OrderMatchingTest is DSTest, VmCheat, EventfulMarket, MatchingEvents {
    MarketTester user1;
    IERC20 dai;
    IERC20 dustToken;
    IERC20 mkr;
    ...
    function setUp() public override {
        ...
        dgd = new DSTokenBase(DGD_SUPPLY);
        DummySimplePriceOracle priceOracle = new DummySimplePriceOracle();
        // otc = new RestrictedSuspendableMatchingMarketWithFees(address(dustToken), 10, address(priceOracle));
        // constructor(IERC20 _mainTradableToken, bool _suspended, IERC20 _dustToken, uint256 _dustLimit, address _priceOracle) RestrictedSuspendableSimpleMarket(_mainTradableToken, _suspended) {

        // otc = new RestrictedSuspendableMatchingMarketWithFees(IERC20(dai), false, IERC20(dustToken), 10, address(priceOracle));
        // otc = new RestrictedSuspendableMatchingMarketWithFees(IERC20(dai), false, matchingMarketConfiguration );
