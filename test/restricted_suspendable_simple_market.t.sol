...
contract RestrictedRestrictedSuspendableSimpleMarket_Test is DSTest, VmCheat, EventfulMarket {
    MarketTester user1;
    ERC20 dai;
    ERC20 mkr;
    ...
    function setUp() public override {
        super.setUp();
        console2.log("RestrictedRestrictedSuspendableSimpleMarket_Test: setUp()");
