...
const restricted_suspendable_matchingMarket_params = require("../deploy-params/RestrictedSuspendableMatchingMarket-params")
...
module.exports = async (
  ...
  const matchingMarket_contractName = getContractName(restricted_suspendable_matchingMarket_params);
  ...
  const restricted_suspendable_matching_market_paramsArgs = getParamsArgs(restricted_suspendable_matchingMarket_params, chainId);
  const isMarketSuspended = restricted_suspendable_matching_market_paramsArgs[0];
  const dustLimit = restricted_suspendable_matching_market_paramsArgs[1];
  ...
  const matchingMarket_deployArgs = getDeployArgs(restricted_suspendable_matchingMarket_params, chainId);
  console.log();
...
module.exports.tags = ['RestrictedSuspendableMatchingMarket'];
